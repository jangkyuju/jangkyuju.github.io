...
| Step | Action                                             | Agent                                                       |
| ---- | -------------------------------------------------- | ----------------------------------------------------------- |
| 1    | Analyze React source →`output/design-spec.json` | code-analyzer (`.Codex/agents/code-analyzer/AGENT.md`)   |
| 2    | Build Jekyll site from spec                        | jekyll-builder (`.Codex/agents/jekyll-builder/AGENT.md`) |
